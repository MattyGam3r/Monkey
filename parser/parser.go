...
type (
	...
	infixParseFn  func(ast.Expression) ast.Expression //The argument is the "left side" of the infix operator that's being parsed
)
...
func (p *Parser) parseIntegerLiteral() ast.Expression {
	//lit is now a IntegerLiteral with the token same as the current one in the
	//Parser
	lit := &ast.IntegerLiteral{Token: p.curToken}

	//It converts the current tokens literal (string) to an integer
	...
	//Then it sets the value of the integer value to the one converted
	lit.Value = value
	//and returns it...
	return lit
}
